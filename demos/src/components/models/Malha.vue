<template>
  ...
  <div class="demo imdb-bidirectional-lstm">
    <div class="title">
      <span>Malha de Classificação</span>
    </div>
...
const MODEL_FILEPATHS_DEV = {
  model: '/demos/data/malha/model.json',
  weights: '/demos/data/malha/model_weights_kfold_1.buf',
  metadata: '/demos/data/malha/model_metadata.json'
}
